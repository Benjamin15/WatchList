...
if grep -q "SWIPE_THRESHOLD = 15" /Users/ben/workspace/WatchParty/mobile/src/screens/RoomScreen.tsx; then
    echo "   ✓ Seuil de distance réduit à 15px"
else
    echo "   ❌ Erreur: Seuil de distance non réduit"
fi

if grep -q "SWIPE_VELOCITY_THRESHOLD = 0.08" /Users/ben/workspace/WatchParty/mobile/src/screens/RoomScreen.tsx; then
    echo "   ✓ Seuil de vélocité réduit à 0.08"
else
    echo "   ❌ Erreur: Seuil de vélocité non réduit"
fi

if grep -q "ACTIVATION_THRESHOLD = 0.5" /Users/ben/workspace/WatchParty/mobile/src/screens/RoomScreen.tsx; then
...
if grep -q "verticalMovement \* 0.2" /Users/ben/workspace/WatchParty/mobile/src/screens/RoomScreen.tsx; then
    echo "   ✓ Ratio horizontal/vertical amélioré (20%)"
else
    echo "   ❌ Erreur: Ratio horizontal/vertical non amélioré"
fi

if grep -q "horizontalMovement > 2" /Users/ben/workspace/WatchParty/mobile/src/screens/RoomScreen.tsx; then
...
if ! grep -q "👉 Glisser" /Users/ben/workspace/WatchParty/mobile/src/screens/RoomScreen.tsx; then
...
if ! grep -q "💡 Glissez un média" /Users/ben/workspace/WatchParty/mobile/src/screens/RoomScreen.tsx; then
...
if ! grep -q "swipeHintContainer:" /Users/ben/workspace/WatchParty/mobile/src/screens/RoomScreen.tsx; then
    echo "   ✓ Style swipeHintContainer supprimé"
else
    echo "   ❌ Erreur: Style swipeHintContainer encore présent"
fi

if ! grep -q "swipeHintPermanent:" /Users/ben/workspace/WatchParty/mobile/src/screens/RoomScreen.tsx; then
    echo "   ✓ Style swipeHintPermanent supprimé"
else
    echo "   ❌ Erreur: Style swipeHintPermanent encore présent"
fi

if ! grep -q "hint:" /Users/ben/workspace/WatchParty/mobile/src/screens/RoomScreen.tsx; then
    echo "   ✓ Style hint supprimé"
else
    echo "   ❌ Erreur: Style hint encore présent"
fi

if ! grep -q "hintText:" /Users/ben/workspace/WatchParty/mobile/src/screens/RoomScreen.tsx; then
...
if grep -q "distance > 10 && velocity > 0.03" /Users/ben/workspace/WatchParty/mobile/src/screens/RoomScreen.tsx; then
    echo "   ✓ Condition ultra-permissive 10px + 0.03 vélocité"
else
    echo "   ❌ Erreur: Condition ultra-permissive manquante"
fi

if grep -q "distance > 12 && velocity > 0.005" /Users/ben/workspace/WatchParty/mobile/src/screens/RoomScreen.tsx; then
...
if grep -q "→" /Users/ben/workspace/WatchParty/mobile/src/screens/RoomScreen.tsx; then
